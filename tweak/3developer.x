...
//名称
    ...
    SBSApplicationShortcutSystemPrivateIcon *flexIcon =
        [[SBSApplicationShortcutSystemPrivateIcon alloc]
            initWithSystemImageName:@"chevron.left.slash.chevron.right"];//图标位置
    [flexItem setIcon:flexIcon];//设置图标
    flexItem.type = @"com.hearse.3developer.flex";//key
    [originalItems addObject:flexItem];//添加flex
