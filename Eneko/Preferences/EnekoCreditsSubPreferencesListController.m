//
//  EnekoCreditsSubPreferencesListController.m
//  Eneko
//
//  Created by Alexandra (@thatcluda)
//

#import "EnekoCreditsSubPreferencesListController.h"

@implementation EnekoCreditsSubPreferencesListController

- (void)viewDidLoad {

    [super viewDidLoad];

    self.appearanceSettings = [EnekoAppearanceSettings new];
...
- (void)loadFromSpecifier:(PSSpecifier *)specifier {
    ...
    NSString* sub = [specifier propertyForKey:@"EnekoSub"];
