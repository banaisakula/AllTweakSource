#include "SYPRootListController.h"

@implementation SYPRootListController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.iconView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/SeeYaPrefs.bundle/icon.png"];
